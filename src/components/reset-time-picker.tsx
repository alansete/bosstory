      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex gap-1 ml-auto">
          <button
            ...
            className={`text-xs px-2 py-1 rounded ${mode === "preset" ? "bg-foreground/10 text-foreground" : "text-muted-foreground hover:text-foreground"}`}
          >
            Reset Timing
          </button>
          <button
            onClick={() => setMode("custom")}
            className={`text-xs px-2 py-1 rounded ${mode === "custom" ? "bg-foreground/10 text-foreground" : "text-muted-foreground hover:text-foreground"}`}
          >
            Custom
          </button>
        </div>
